...
public class EmployeeControllerIT extends AbstractContainerBaseTest {
	...
	@Autowired
	public EmployeeControllerIT(MockMvc mockMvc, ExpenseRepository expenseRepository, ObjectMapper objectMapper) {
		super();
	...
	@Test
	public void givenListOfExpense_whenGetAllExpense_thenReturnExpense()throws Exception{
	...
	// positive scenarios - valid expense id
	// JUnit test for GET expense by id REST API
	
	@Test
	public void givenExpenseId_whenGetExpenseById_thenReturnExpenseObject()throws Exception{
	...
	// JUnit test for GET expense by id REST API
	@Test
	public void givenInvalidExpenseId_whenGetExpenseById_thenReturnEmpty()throws Exception{
		// given - precondition or setup
		int expenseId = 1;
		Expense expense = Expense.builder()
				.expenseName("Team Lunch")
	...
	@Test
	public void givenUpdateExpense_whenUpdateExpense_thenReturnUpdatedExpense()throws Exception{
	...
	@Test
	public void givenUpdatedExpense_whenUpdateExpense_thenReturn404() throws JsonProcessingException, Exception {
		Expense expense = Expense.builder()
				.expenseName("Team Lunch")
				.amount(1000)
				.date("2025-04-25")
	...
	@Test
	public void givenExpenseById_whenDeleteExpense_thenReturn200() throws Exception {
		Expense expense = Expense.builder()
				.expenseName("Team Lunch")
				.amount(1000)
				.date("2025-04-25")
