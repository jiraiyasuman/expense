package com.expensetracker_spring.aop;
...
public class ExpenseAspect {
	...
	@Pointcut("execution(* com.expensetracker_spring.controller.*.*(..))")
	private void forControllerPackage() {
		LOGGER.info("LoginUserController class is being executed");
	}
	@Pointcut("com.expensetracker_spring.service.*.*(..))")
	private void forServicePackage() {
		LOGGER.info("LoginUserService class is being executed");
	}
	@Pointcut("com.expensetracker_spring.repository.*.*(..))")
